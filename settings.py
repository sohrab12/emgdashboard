...
DATABASE_NAME = 'C:/Projects/EMGDashboardDB.db'             # Or path to database file if using sqlite3.
...
MEDIA_ROOT = 'c:/UCI/Winter2010/Informatics191B/emgdashboard/static/'  #absolute path to media
...
TEMPLATE_DIRS = (
    "C:/UCI/Winter2010/Informatics191B/emgdashboard/templates/"
